          ...
          <div>
            ...
            {post.realEstateJuridical && (
              <TagProperty
                style={{
                  background:
                    hrefMain.href == PUBLIC_ROUTES.BROKERAGE_FLOOR.href
                      ? colors.common
                      : colors.button,
                }}
              >
            ...
            <RowPrice>
              <RowPriceLeft gap={true}>
                <Typography.Title style={{ fontFamily: 'Inter' }} level={5}>
                  The Brevoort
                </Typography.Title>
              ...
              <div>
                ...
                <div>
                  ...
                  >
                    {formatNumToUnit(post.realEstateValueSalePrice, translate)}
                  ...
                  <RowActions style={{ marginTop: -15 }}>
                    <ButtonSave
                      t={translate}
                      idPost={post.realEstateId}
                      IconDefault={<IconStartabtab />}
                      bg="#F9C41F"
                    />
                    <a>
                      <ButtonShare
                        t={translate}
                        icon={<IconSharetabtab />}
                        bg="white"
                        borderColor="#F9C41F"
                      />
                    </a>
                    ...
                    >
                      <Link href={'#rating-review'} legacyBehavior>
