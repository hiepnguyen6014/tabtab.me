...
import { Col, Divider, Row, Table, Typography, Image, Button, Slider, InputNumber } from 'antd';
import {
    ...
    <>
      <DefaultWrapperWithBg>
        <DefaultContentInWrapper>
          <RowPriceLeft>
            <DefaultRowTitle>
              <label style={{ fontFamily: "Inter", fontSize: 28, fontWeight: "700", marginBottom: 20 }}>Loan Calculator</label>
            </DefaultRowTitle>
            <Row style={{ padding: "22px 22px 0 22px", borderWidth: 1, borderColor: "#39B4F333", borderRadius: 12, borderStyle: 'solid', backgroundColor: "#39B4F305", justifyContent:"space-between" }}>
              <Col lg={5} md={11} xs={24} style={{marginBottom:22}}>
                <label style={{ fontFamily: "Inter", fontSize: 16, fontWeight: '500', color: "#7A7A7A", marginBottom: 12 }}>
                  Propertiy Price
                </label>
                <div>
                ...
                <label style={{ fontFamily: "Inter", fontSize: 16, fontWeight: '500', color: "#7A7A7A", margin: '30px 0 12px 0' }}>
                  Interest Rate
                </label>
                <div>
                  <div style={{ display: 'flex', borderWidth: 1, borderColor: "#D3D3D3", borderStyle: 'solid', justifyContent:'space-between' }}>
                    <InputNumber
                      min={1}
                      max={20}
                      style={{
