    ...
    <>
      <DefaultWrapperWithBg style={{ marginTop: -70 }}>
        <DefaultContentInWrapperBN grid={true}>
          <RowPriceLeft>
            <DefaultRowTitle>
              <label style={{ fontSize: 28, fontWeight: "700", marginBottom: 20 }}>Tên BDS hoặc tên dự án</label>
            </DefaultRowTitle>
            <BlockName>
              ...
              <div>
                <div className="d-flex justify-content-between" style={{ paddingLeft: 20, paddingTop: 30 }}>
                  <div>
                    ...
                    <span>
                      <label style={{ fontSize: 16, fontWeight: "700", marginRight: 10, color: '#7A7A7A' }}>Tổng số căn hộ</label>
                      <label style={{ fontSize: 16, fontWeight: "700" }}>3000</label>
                    </span>
                  </div>
                  <div style={{ marginLeft: 8 }}>
                    ...
                    <span>
                      <label style={{ fontSize: 16, fontWeight: "700", marginRight: 10, color: '#7A7A7A' }}>Số Block</label>
                      <label style={{ fontSize: 16, fontWeight: "700" }}>6</label>
                    </span>
                  </div>
                ...
                <div style={{ paddingLeft: 20 }}>
                  <div className="d-flex justify-content-between" >
                    <div>
                      ...
                      <span>
                        <label style={{ fontSize: 16, fontWeight: "700", marginRight: 10, color: '#7A7A7A' }}>Số Tầng</label>
                        <label style={{ fontSize: 16, fontWeight: "700" }}>42</label>
                      </span>
                    </div>
                    <div>
                      <div style={{ marginRight: 12, marginBottom: 7 }}>
                      ...
                      <span>
                        <label style={{ fontSize: 16, fontWeight: "700", marginRight: 10, color: '#7A7A7A' }}>Biệt thự</label>
                        <label style={{ fontSize: 16, fontWeight: "700" }}>20</label>
                      </span>
                    </div>
                  </div>
                ...
                <div style={{ paddingLeft: 20 }}>
                  ...
                  <span>
                    <label style={{ fontSize: 16, fontWeight: "700", marginRight: 10, color: '#7A7A7A' }}>Số căn hộ</label>
                    <label style={{ fontSize: 16, fontWeight: "700" }}>672</label>
                  </span>
                </div>
                <div style={{ paddingLeft: 20 }}>
                  <div style={{ marginRight: 12, marginBottom: 7 }}>
                  ...
                  <span>
                    <label style={{ fontSize: 16, fontWeight: "700", marginRight: 10, color: '#7A7A7A' }}>Năm hoàn thành</label>
                    <label style={{ fontSize: 16, fontWeight: "700" }}>2021</label>
                  </span>
                </div>
                <div style={{ justifyContent: 'center', display: 'flex', paddingLeft: 20, paddingRight: 20 }}>
                  <Button style={{ backgroundColor: "#F9C41F", borderRadius: 8, height: 'auto', marginTop: 5, marginBottom: 24, width: '100%', whiteSpace: 'break-spaces' }}>
                    <label style={{ fontSize: 16, fontWeight: '700', paddingTop: 8, paddingBottom: 8 }}>XEM CHI TIẾT</label>
                  </Button>
                </div>
