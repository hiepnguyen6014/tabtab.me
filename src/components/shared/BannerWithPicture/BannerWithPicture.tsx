import { SeeAllImages } from '../SeeAllImages/SeeAllImages';
...
const BannerWithPicture = (props: Props) => {
  const { images, t } = props;
  ...
  return (
    <>
      ...
      <BannerDesktop>
        {newImages.length <= 3 ? (
          <Layout3Pictures images3={newImages} />
        ) : (
      ...
      <BannerMobile>
        ...
        >
          {images.map((value, key) => (
            <>
              <SwiperSlide key={key} >
                <Image src={value} alt="" height={250} width="100%"
...
export default memo(BannerWithPicture)