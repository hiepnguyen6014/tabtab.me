...
import { IconRecovery } from '@root/public/icons';
import { Typography } from 'antd';
import { useRouter } from 'next/router';
import { ColItem, ColItemImage, ItemDate, RowItem, WrapPic } from './PostItem.style';

interface CustomCol {
  left: any;
  right: any;
}
const PostItemHotNews = (props: {
  post: MNewsPost;
  customCol?: CustomCol;
  t:any
}) => {
...
export default PostItemHotNews
