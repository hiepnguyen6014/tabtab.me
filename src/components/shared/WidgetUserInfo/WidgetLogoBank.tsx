...
export const WidgetLogoBank = (props: { post: MPostDetail, t: any }) => {
    ...
    return (
        <>
            <WidgetWrap>
                <div style={{ backgroundColor: '#222222', height: 'auto', textAlign: 'center', display: 'flex', justifyContent: 'center', padding: 5 }}>
                    <label style={{ color: 'white', fontSize: 26, fontWeight: '700', fontFamily: "Inter" }}>Logo Bank</label>
                </div>
                <div style={{ padding: 16 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', marginBottom: 16 }}>
                        <div style={{ height: 'auto', width: '45%', display:'flex' }}>
                            ...
                            <span style={{ fontSize: 16, fontWeight: 600, fontFamily: "Inter", color: '#7A7A7A' }}>Phone</span>
                        </div>
                        <span style={{ fontSize: 16, fontWeight: 600, fontFamily: "Inter" }}>0909672981</span>
                    </div>
                    ...
                    <WidgetAction style={{marginTop:-20}}>
                        ...
                        <TextEmail t={t} email={contactRecord.email}>
                            <Button type='primary' style={{ backgroundColor: "#F9C41F", borderRadius: 8, height: 'auto', padding: 13, marginTop: 24, width: '100%', whiteSpace: "break-spaces" }}>
                                <IconMessTabTab />
                                <label style={{ fontSize: 16, fontWeight: '700', fontFamily: "Inter" }}>Chat với anh Cody</label>
                            </Button>
                        </TextEmail>
                    </WidgetAction>
                </div>
