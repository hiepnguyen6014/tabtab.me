                    ...
                    <TeacherContainer>
                        ...
                        <span style={{padding:15}}>
                            <div style={{ display: 'flex' }}>
                                <Typography.Title style={{ fontSize: 28, fontWeight: '700', fontFamily: "Inter", marginBottom: 0 }}>
                                    Kathryn Murphy
                                </Typography.Title>
                            </div>
                            ...
                            <div style={{ display: "flex", marginTop: 30, paddingRight:30}}>
                                <div style={{marginRight:20}}>
                                    <div style={{ fontSize: 18, fontWeight: '700', fontFamily: "Inter", justifyContent:'center',display:'flex' }}>200</div>
                                    <div style={{ fontSize: 13, fontWeight: '500', fontFamily: "Inter", color: "#7A7A7A" }}>Lesson</div>
                                </div>
                                <div style={{marginRight:20}}>
                                    <div style={{ fontSize: 18, fontWeight: '700', fontFamily: "Inter", justifyContent:'center',display:'flex' }}>7000</div>
                                    <div style={{ fontSize: 13, fontWeight: '500', fontFamily: "Inter", color: "#7A7A7A" }}>Student</div>
                                </div>
                                <div style={{marginRight:20}}>
                                    <div style={{ fontSize: 18, fontWeight: '700', fontFamily: "Inter", justifyContent:'center',display:'flex' }}>4</div>
                                    <div style={{ fontSize: 13, fontWeight: '500', fontFamily: "Inter", color: "#7A7A7A" }}>Experience</div>
                                </div>
                            </div>
                        </span>
                    </TeacherContainer>
