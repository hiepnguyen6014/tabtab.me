...
import { DefaultContentInWrapperMajor, DefaultWrapperWithBg, RowPrice, RowPriceLeft, FilterContainer, ColWrap, FDesktop } from '../ELearning.style'
                        ...
                        <SpotlightWrap>
                            <SpotlightText>
                                ...
                                <div className='d-flex justify-content-center my-5'>
                                    <Button className='button-seemore' style={{ background: "#F0F2F5" }} >
