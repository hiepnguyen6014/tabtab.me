...
const ValuationChart = (props: Props) => {
  ...
  const cleanedCategory = categoryList.filter(
    item =>
      item.realEstateCategoryId !==
      valueSelected?.realEstateCategory?.realEstateCategoryId,
  );
  ...
  return (
    <>
      ...
      <WrapperWithGrid>
        {/* Chart 2 */}
        <ChartCard
          filter={sub1ChartQueryBuilder}
          theme={'green'}
          t={translate}
        />
        {/* Chart 3 */}
        <ChartCard
          filter={sub2ChartQueryBuilder}
          theme={'blue'}
          t={translate}
        />
      </WrapperWithGrid>
