...
import { IconEmailTabTab, IconPhoneTabTab, Logo5Team, Plus } from "@root/public/icons";
...
export default function FindpersonDetailsComponent({translate}) {
  ...
  return (
        <DefaultLayout t={translate}>
            <div style={{ position: 'relative', width: '95%', maxWidth: 1200, margin: 'auto' }}>
                <label style={{ fontSize: 14, fontWeight: '500', fontFamily: "Inter", color: '#7A7A7A', marginTop: 20, marginBottom: 30 }}>
                    Tên Section
                    <label style={{ marginRight: 10, marginLeft: 10 }}>{">"}</label>
                    <label style={{ fontSize: 14, fontWeight: '500', fontFamily: "Inter", color: '#F9BD06' }}>
                        find-person
                    </label>
                </label>
            </div>
            ...
            <FDesktopSecond grid={true}>
                <div />
                <div>
                    <Typography style={{ fontSize: 20, fontFamily: "Inter", fontWeight: "700", marginBottom: 20 }}>Map Listing</Typography>
