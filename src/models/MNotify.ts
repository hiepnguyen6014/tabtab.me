import { ROUTES_NOTIFY, USER_NOTIFY } from './../components/pages/MyNotification/detail/notifyService';
import { ROUTES, PUBLIC_ROUTES } from '@constants';
import {
  convertDateToStringWithTime,
} from './../core/utils/HandleDate';
...
export class MNotify {
  ...
  constructor(param: any) {
    ...
    this.messageTimeReceive = convertDateToStringWithTime(param.createdAt) || '';
    ...
    this.customerMessageImage = param.customerMessageImage || "https://roadmap-tech.com/wp-content/uploads/2019/04/placeholder-image.jpg";
    // Realte post
    this.detailHref = hrefNotify(this.messageType, param.messageCustomerData, param.messageCustomerId )
  }
}
...
function hrefNotify(
  ...
  // Notify real estate
  if (messageType == 3) {
    const parseMessageCustomerData: MCustomerData = JSON.parse(messageCustomerData);
      return {
